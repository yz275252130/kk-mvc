...
<form class="cmxform form-horizontal tasi-form bvform" method="post"
	action="./baseDictionary/add?callbackMethod=refreshTable"
	data-bv-feedbackicons-valid="glyphicon glyphicon-ok"
	data-bv-feedbackicons-invalid="glyphicon glyphicon-remove"
	data-bv-feedbackicons-validating="glyphicon glyphicon-refresh"
	
	>
	<input type="hidden" name="parentCode" value="${param.code }" /> 
	...
	<div class="modal-body">
		<div class="form-group">
			<label for="name" class="control-label">名称 *</label> <input
				...
				name="name" placeholder="名称" data-bv-notempty="true"
				data-bv-notempty-message="请输字典户名">
		</div>
		<div class="form-group">
			<label for="code" class="control-label">code </label> <input
				type="text" class="form-control" id="code" name="code" data-bv-notempty="true"
